###########################################################################
## Makefile generated for component 'rover_finalEx'. 
## 
## Makefile     : rover_finalEx.mk
## Generated on : Sat Mar 11 11:58:38 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/rover_finalEx.elf
...
PRODUCT_NAME              = rover_finalEx
MAKEFILE                  = rover_finalEx.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/Arduino-_Engineering-_Kit_Rev_2/PROJECTS/WEBCAM_CONTROLLED_ROVER/finalExercise
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/vikra/DOCUME~1/MATLAB/R2022b/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/rover_finalEx.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/shared/svd/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/rover_finalEx_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_SAMD_ROOT)/tools/CMSIS/$(SAMD_CMSIS_VERSION)/CMSIS/Include -I$(ARDUINO_SAMD_ROOT)/tools/CMSIS-Atmel/$(SAMD_CMSIS_ATMEL_VERSION)/CMSIS/Device/ATMEL -I$(ARDUINO_SAMD_ROOT)/hardware/samd/$(SAMD_LIB_VERSION)/cores/arduino -I$(ARDUINO_SAMD_ROOT)/hardware/samd/$(SAMD_LIB_VERSION)/variants/nano_33_iot -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARMCOR~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/toolbox/target/SUPPOR~1/ARMCOR~1/xcp/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/aIDE/portable/SKETCH~1/LIBRAR~1/WiFiNINA/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/aIDE/portable/packages/arduino/hardware/samd/1835A9~1.9/LIBRAR~1/Wire -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/aIDE/portable/packages/arduino/hardware/samd/1835A9~1.9/LIBRAR~1/SPI -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/aIDE/LIBRAR~1/Servo/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2022b/aIDE/LIBRAR~1/Servo/src/samd
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=10 -DMW_PRESCALAR=128 -DMW_TIMERCOUNT=625 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=2 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL1_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0 -D_RTT_WIFI_TCP_=2 -D_RTT_WIFI_TCP_SERVER_PORT_ORDERED=25005,25000,25001,25002,25003 -D_RTT_WIFI_TCP_SERVER_=5 -D_RTT_WIFI_Local_IP1=192 -D_RTT_WIFI_Local_IP2=168 -D_RTT_WIFI_Local_IP3=1 -D_RTT_WIFI_Local_IP4=20 -D_RTT_WIFI_SSID="Patel" -D_RTT_WIFI_WPA_PASSWORD="Keppel.19" -D_RTT_WIFI_WPA=1 -D_RTT_DISABLE_Wifi_DHCP_=0 -D_RTT_USE_SERIAL0_ -DNANO_MOTOR_CARRIER
...
DEFINES_STANDARD = -DMODEL=rover_finalEx -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduinoI2C.o MW_WiFiTCP.o rover_finalEx.o rover_finalEx_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
%.o : $(START_DIR)/rover_finalEx_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/rover_finalEx_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/rover_finalEx_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/rover_finalEx_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/rover_finalEx_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_WiFiTCP.o : C:/ProgramData/MATLAB/SupportPackages/R2022b/toolbox/target/supportpackages/arduinobase/src/MW_WiFiTCP.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/rover_finalEx_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rover_finalEx.o : $(START_DIR)/rover_finalEx_ert_rtw/rover_finalEx.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rover_finalEx_data.o : $(START_DIR)/rover_finalEx_ert_rtw/rover_finalEx_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
