###########################################################################
## Makefile generated for component 'simulink_rover_control'. 
## 
## Makefile     : simulink_rover_control.mk
## Generated on : Sat Feb 25 16:41:03 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/simulink_rover_control.elf
...
PRODUCT_NAME              = simulink_rover_control
MAKEFILE                  = simulink_rover_control.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/Arduino-_Engineering-_Kit_Rev_2/PROJECTS/WEBCAM_CONTROLLED_ROVER/Task_0
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/simulink_rover_control.elf
...
DEFINES_STANDARD = -DMODEL=simulink_rover_control -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduinoI2C.o MW_arduino_digitalio.o xcp_ext_mode.o simulink_rover_control.o simulink_rover_control_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o rtiostream_serial_daemon.o sys_arch.o
...
%.o : $(START_DIR)/simulink_rover_control_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/simulink_rover_control_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/simulink_rover_control_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/simulink_rover_control_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/simulink_rover_control_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/simulink_rover_control_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


simulink_rover_control.o : $(START_DIR)/simulink_rover_control_ert_rtw/simulink_rover_control.c
	$(CC) $(CFLAGS) -o "$@" "$<"


simulink_rover_control_data.o : $(START_DIR)/simulink_rover_control_ert_rtw/simulink_rover_control_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
